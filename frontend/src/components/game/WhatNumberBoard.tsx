  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <span className={cn(
          "grid size-8 shrink-0 place-items-center rounded-full border text-xs font-black text-amber-50",
          isActive ? "border-amber-200/70 bg-gradient-to-br from-amber-300 to-amber-700 text-slate-950" : "border-amber-100/20 bg-[#6d3d22]",
        )}>
          {player?.avatar ?? "?"}
        </span>
